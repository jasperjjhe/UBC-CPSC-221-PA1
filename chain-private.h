 ...
 * @author CPSC 221
 * 
 * If you want to define private member functions for Chain,
 ...
 * 
 * Write your function declarations here as if they were inline starting from line 113 of chain.h
 * 
 * e.g.
 * 
